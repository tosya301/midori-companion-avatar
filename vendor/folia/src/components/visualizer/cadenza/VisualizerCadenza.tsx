...
const buildWordPlacements = (
    ...
    placementPlans.forEach(plan => {
        const { fragment, lineStart, lineIndex, fragmentIndex, emphasis, width, height, scale, collisionWidth, collisionHeight, padding } = plan;
        ...
        placements.push({
            id: `${lineStart}-${fragment.word.text}-${fragment.wordIndex}-${lineIndex}-${fragmentIndex}-${fragment.fragmentIndexInWord}`,
