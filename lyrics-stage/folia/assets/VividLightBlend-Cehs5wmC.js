import{T as e,X as t,i as n,j as r,z as i}from"./Shader-DwRVIl2v.js";import{t as a}from"./Filter-DoJaSZh7.js";var o=`
...
fn mainFragment(
  @location(0) uv: vec2<f32>
   ...
   return out;
}`,l=class extends a{constructor(t){let a=t.gpu,l=u({source:c,...a}),d=r.from({vertex:{source:l,entryPoint:`mainVertex`},fragment:{source:l,entryPoint:`mainFragment`}}),f=t.gl,p=u({source:o,...f}),m=i.from({vertex:s,fragment:p}),h=new e({uBlend:{value:1,type:`f32`}});super({gpuProgram:d,glProgram:m,blendRequired:!0,resources:{blendUniforms:h,uBackTexture:n.EMPTY}})}};function u(e){let{source:t,functions:n,main:r}=e;return t.replace(`{FUNCTIONS}`,n).replace(`{MAIN}`,r)}var d=`
